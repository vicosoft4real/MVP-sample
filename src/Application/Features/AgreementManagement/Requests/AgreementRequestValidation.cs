...
public class AgreementRequestValidation: AbstractValidator<CreateAgreementRequest>
{
    public AgreementRequestValidation()
    {
    ...
    public static AgreementRequestValidation Create() => new();
}